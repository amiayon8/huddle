    ...
    for (const msg of userMessages) {
      ...
      if (safetyCheck.isInappropriate) {
        return NextResponse.json({
          reply:
            "I'm Pip, your deliberate practice coach! My focus is strictly on helping you build software engineering skills and achieve your career goals. Let's get back to today's focus session!",
...
4. TONE & FORMAT: Casual, warm, non-corporate, encouraging. Keep responses concise (2-4 short sentences or bullet points).`;
    ...
    return NextResponse.json({
      reply:
        "Pip here! I'm right by your side. Let's focus on today's single action.",
